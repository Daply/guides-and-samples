...
public class UserAction extends play.mvc.Action.Simple {
    ...
    @Singleton
    @Inject
    public UserAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(UserAction.class, "responsesTimer"));
    }
